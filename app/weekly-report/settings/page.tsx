...
import WeeklyReportSettingsClient from './client';

export const metadata = {
  title: '周报设置 - Claw Diary',
  description: '配置周报推送和通知设置',
};
      ...
      <header className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-b border-purple-100 dark:border-purple-800">
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-xl font-bold text-gray-800 dark:text-white">⚙️ 周报设置</h1>
          </div>
        </div>
      </header>
      <WeeklyReportSettingsClient />
    </div>
  );
}